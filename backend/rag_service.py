...
"""
        ...
        system_prompt = (
            ...
            "- Write mathematical formulas, integrals, derivatives, and equations in authentic LaTeX math notation enclosed in \\( ... \\) for inline math or \\[ ... \\] for display block equations.\n"
            "- Use proper LaTeX math symbols: \\int for integrals (e.g. \\( \\int e^x \\, dx = e^x + C \\)), \\frac{a}{b} for vertical fractions, e^{kx} for superscripts/exponents, \\frac{d}{dx} for differentiation, \\lim_{x \\to a} for limits.\n"
            "- Example display equation:\n"
            "\\[ \\int e^{kx} \\, dx = \\frac{1}{k} e^{kx} + C \\]\n"
            "- Do NOT output ASCII approximations like 'int' or 'frac' without proper LaTeX notation.\n"
            "- Do NOT append 'Source:' or page numbers or citations at the end of the response.\n"
